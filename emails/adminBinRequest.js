module.exports = function ({ email, binType, url }) {
                                                                                          ...
                                                                                          <table cellspacing="0"
                                                                                              ...
                                                                                              <tr>
                                                                                                  <td class=""
                                                                                                      ...
                                                                                                      <img src="https://img.mailinblue.com/4684409/images/content_library/original/63b5abe821a57e14da54d748.png"
                                                                                                          width="200"
                                                                                                          border="0"
                                                                                                          class=""
                                                                                                  ...
                                                                                                  <td align="center"
                                                                                                      ...
                                                                                                      <div>
                                                                                                          <h1 class="default-heading1"
                                                                                                              style="margin: 0; color: #1f2d3d; font-family: arial,helvetica,sans-serif; font-size: 36px;">
                                                                                                              NEW BIN !!!
                                                                                                          </h1>
                                                                                                      </div>
                                                                                                  </td>
                                                                                          ...
                                                                                          <table cellspacing="0"
                                                                                              ...
                                                                                              <tr>
                                                                                                  <td align="left"
                                                                                                      ...
                                                                                                      style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 16px; line-height: 1.5; padding-bottom: 15px; padding-top: 15px; text-align: left;">
                                                                                                      <div>
                                                                                                          <p
                                                                                                              style="margin: 0;">
                                                                                                              Ο χρήστης
                                                                                                              <span
                                                                                                                  style="font-family: Arial, helvetica, sans-serif;"><strong>${email}</strong></span><span
                                                                                                                  style="font-family: 'Arial black', helvetica, sans-serif;">
                                                                                                              </span><span
                                                                                                                  style="font-family: Arial, helvetica, sans-serif;">μόλις
                                                                                                                  ανέβασε
                                                                                                                  μια
                                                                                                                  φωτόγραφία
                                                                                                                  για έναν
                                                                                                                  κάδο
                                                                                                                  <strong>${binType}</strong>
                                                                                                                  μέσω της
                                                                                                                  εφαρμογής
                                                                                                                  <strong>ECO
                                                                                          ...
                                                                                          <table cellspacing="0"
                                                                                              ...
                                                                                              <tr>
                                                                                                  <td height="18"
                                                                                                      ...
                                                                                                      <!--[if mso]> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://${url}" style="v-text-anchor:middle; height: 41px; width: 289px;" arcsize="10%" fillcolor="#0092FF" strokecolor="#0092FF" strokeweight="1px" data-btn="1"> <w:anchorlock/> <div style="display:none;"> <center class="default-button"><p>ΕΛΕΓΧΟΣ</p></center> </div> </v:roundrect> <![endif]-->
                                                                                                      <!--[if !mso]><!-- -->
                                                                                                      <a href="http://${url}"
